...
Original file is located at
    https://colab.research.google.com/drive/1y0GVoXHpftZryflOc7mdc0AUVjvkcMnm
"""
...
data_test = {
        ...
        'url': [
            ...
            'https://www.shl.com/solutions/products/product-catalog/view/sales-support-specialist-solution/',
            ...
            'https://www.shl.com/solutions/products/product-catalog/view/sales-and-service-phone-solution/',
            'https://www.shl.com/solutions/products/product-catalog/view/sales-and-service-phone-simulation/',
            ...
            'https://www.shl.com/solutions/products/product-catalog/view/graduate-8-0-job-focused-assessment-4228/'
            ],
            [
            ...
            'https://www.shl.com/solutions/products/product-catalog/view/automata-fix-new/',
            'https://www.shl.com/solutions/products/product-catalog/view/automata-front-end/',
...
import json
df_test["assessments"] = df_test["assessments"].apply(json.dumps)
df_test["url"] = df_test["url"].apply(json.dumps)
df_test.to_csv("benchmark_test.csv", index=False)

import json

benchmark_df = pd.read_csv("benchmark_test.csv")
benchmark_df["assessments"] = benchmark_df["assessments"].apply(json.loads)
benchmark_df["url"] = benchmark_df["url"].apply(json.loads)